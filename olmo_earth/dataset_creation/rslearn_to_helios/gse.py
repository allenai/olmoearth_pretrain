"""Post-process ingested Google Satellite Embedding data into the Helios dataset."""
...
from olmo_earth.data.constants import Modality, TimeSpan
from olmo_earth.dataset.utils import get_modality_fname
...
def convert_gse(window_path: UPath, helios_path: UPath) -> None:
    """Add Google Satellite Embedding data for this window to the Helios dataset.
    ...
    metadata_fname = get_modality_temp_meta_fname(
        helios_path, Modality.GSE, TimeSpan.STATIC, window.name
    )
