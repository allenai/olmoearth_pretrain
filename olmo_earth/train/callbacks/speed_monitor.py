...
from olmo_earth.train.train_module.galileo import GalileoTrainModule
from olmo_earth.train.train_module.latent_mim import LatentMIMTrainModule
from olmo_earth.train.train_module.mae import MAETrainModule
