...
from helios.train.train_module.supervised_contrastive_latentmim import (
    SupervisedContrastiveLatentMIMTrainModuleConfig,
)
...
def train_module_config(
    ...
    config = SupervisedContrastiveLatentMIMTrainModuleConfig(
...
def test_train_batch_without_missing_modalities(
    ...
    train_module_config: SupervisedContrastiveLatentMIMTrainModuleConfig,
) -> None:
