...
def latent_mim_model(
    ...
    latent_mim_config = LatentMIMMoEConfig(
...
def train_module_config(
    ...
    config = LatentMIMMoETrainModuleConfig(
...
def test_train_batch_without_missing_modalities(
    ...
    latent_mim_model: LatentMIMMoE,
    train_module_config: LatentMIMMoETrainModuleConfig,
