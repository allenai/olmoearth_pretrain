...
class TestMultiModalPatchEmbeddings:
    ...
    def test_missing_modality_gets_fake_inputs(self) -> None:
        ...
        from olmoearth_pretrain.nn.flexi_vit import MultiModalPatchEmbeddings
        ...
        B, H, W, T = 2, 16, 16, 3
        s2_bands = Modality.SENTINEL2_L2A.num_bands  # 12 bands
        s2_band_sets = Modality.SENTINEL2_L2A.num_band_sets  # 3 band sets
