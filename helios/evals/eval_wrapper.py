...
from helios.evals.models import DINOv2, DINOv3, GalileoWrapper, Panopticon, DOFAv2
...
def get_eval_wrapper(model: nn.Module, **kwargs: Any) -> EvalWrapper:
    ...
    elif isinstance(model, DOFAv2):
        logger.info("Using DOFAv2EvalWrapper")
        return DOFAv2EvalWrapper(model=model, **kwargs)
    else:
