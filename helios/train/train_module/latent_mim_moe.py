    ...
    def train_batch(
        ...
        for microbatch_idx, microbatch in enumerate(microbatches):
            with self._train_microbatch_context(microbatch_idx, num_microbatches):
                ...
                # make sure the latlons are visible to the encoder
                masked_batch_d = masked_batch.as_dict(return_none=False)
                masked_batch_d["latlon_mask"] = (
                    torch.ones_like(masked_batch_d["latlon_mask"])
