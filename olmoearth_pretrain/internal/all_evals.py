...
EVAL_TASKS = {
    ...
    "gb2_dynamic_earthnet": DownstreamTaskConfig(
        ...
        probe_lr=0.1,
        eval_interval=Duration.epochs(10),
        input_modalities=[Modality.NAIP.name, Modality.SENTINEL2_L2A.name],
        epochs=50,
        eval_mode=EvalMode.LINEAR_PROBE,
        primary_metric=EvalMetric.MIOU,
        patch_size=4,
    ...
    "gb2_everwatch": DownstreamTaskConfig(
        ...
        norm_method=NormMethod.NORM_NO_CLIP_2_STD,
        eval_interval=Duration.epochs(10),
        input_modalities=[Modality.NAIP.name],
        eval_mode=EvalMode.KNN,
        primary_metric=EvalMetric.MACRO_F1,
        epochs=50,
    ),
    "gb2_flair2": DownstreamTaskConfig(
        ...
        probe_lr=0.1,
        eval_interval=Duration.epochs(10),
        input_modalities=[Modality.NAIP.name, Modality.SRTM.name],
        epochs=50,
        eval_mode=EvalMode.LINEAR_PROBE,
        primary_metric=EvalMetric.MIOU,
        patch_size=4,
    ...
    "gb2_spacenet6": DownstreamTaskConfig(
        dataset="gb2-spacenet6",
        embedding_batch_size=8,
        probe_batch_size=8,
        num_workers=4,
        pooling_type=PoolingType.MEAN,
    ...
    "gb2_spacenet8": DownstreamTaskConfig(
        dataset="gb2-spacenet8",
        embedding_batch_size=8,
        probe_batch_size=8,
        num_workers=4,
        pooling_type=PoolingType.MEAN,
