    ...
    EMBEDDING_EVAL_TASKS.update(
        {
            ...
            # PASTIS + 10 PLANTEUR windows per class, unified 23-class space.
            f"pastis_planteur_x10_ws{_ws}_ps1_sentinel2": _pastis_ps1_task(
                [Modality.SENTINEL2_L2A.name],
                window_size=_ws,
                dataset="pastis_planteur_x10",
            ),
            # PASTIS + 25 PLANTEUR windows per class, unified 23-class space.
            f"pastis_planteur_x25_ws{_ws}_ps1_sentinel2": _pastis_ps1_task(
                [Modality.SENTINEL2_L2A.name],
                window_size=_ws,
                dataset="pastis_planteur_x25",
            ),
            # PASTIS + 50 PLANTEUR windows per class, unified 23-class space.
            f"pastis_planteur_x50_ws{_ws}_ps1_sentinel2": _pastis_ps1_task(
                [Modality.SENTINEL2_L2A.name],
                window_size=_ws,
                dataset="pastis_planteur_x50",
            ),
            # PASTIS + 100 PLANTEUR windows per class, unified 23-class space.
            f"pastis_planteur_x100_ws{_ws}_ps1_sentinel2": _pastis_ps1_task(
                [Modality.SENTINEL2_L2A.name],
                window_size=_ws,
            ...
            # PASTIS + 10 labelled PIXELS per PLANTEUR class.
            f"pastis_planteur_px10_ws{_ws}_ps1_sentinel2": _pastis_ps1_task(
                [Modality.SENTINEL2_L2A.name],
                window_size=_ws,
                dataset="pastis_planteur_px10",
            ),
            f"pastis_planteur_px10_full_ws{_ws}_ps1_sentinel2": _pastis_ps1_task(
                [Modality.SENTINEL2_L2A.name],
                window_size=_ws,
                dataset="pastis_planteur_px10_full",
            ),
            # PASTIS + 25 labelled PIXELS per PLANTEUR class.
            f"pastis_planteur_px25_ws{_ws}_ps1_sentinel2": _pastis_ps1_task(
                [Modality.SENTINEL2_L2A.name],
                window_size=_ws,
                dataset="pastis_planteur_px25",
            ),
            f"pastis_planteur_px25_full_ws{_ws}_ps1_sentinel2": _pastis_ps1_task(
                [Modality.SENTINEL2_L2A.name],
                window_size=_ws,
                dataset="pastis_planteur_px25_full",
            ),
            # PASTIS + 100 labelled PIXELS per PLANTEUR class.
            f"pastis_planteur_px100_ws{_ws}_ps1_sentinel2": _pastis_ps1_task(
                [Modality.SENTINEL2_L2A.name],
                window_size=_ws,
                dataset="pastis_planteur_px100",
            ),
            f"pastis_planteur_px100_full_ws{_ws}_ps1_sentinel2": _pastis_ps1_task(
                [Modality.SENTINEL2_L2A.name],
                window_size=_ws,
                dataset="pastis_planteur_px100_full",
            ),
            # PASTIS + 1000 labelled PIXELS per PLANTEUR class.
            f"pastis_planteur_px1000_ws{_ws}_ps1_sentinel2": _pastis_ps1_task(
                [Modality.SENTINEL2_L2A.name],
                window_size=_ws,
                dataset="pastis_planteur_px1000",
            ),
            f"pastis_planteur_px1000_full_ws{_ws}_ps1_sentinel2": _pastis_ps1_task(
                [Modality.SENTINEL2_L2A.name],
                window_size=_ws,
            ...
            # CLASS-BALANCING CONTROL (build_xshot_bal.py). Three arms share the
            # same PLANTEUR pixels and differ only in what PASTIS contributes:
            #   pxi{X}  X px of PLANTEUR's 8 classes + ALL 21.5M PASTIS pixels
            #   bal{X}  X px of every class in BOTH sources (27X px; the 4 shared
            #           classes draw X from each source, so they get 2X)
            #   plo{X}  X px of PLANTEUR's 8 classes, no PASTIS at all
            # Offline probing put bal{100} 3.4 mIoU above pxi{100} on 2,700 pixels
            # against 21.5M; these tasks re-measure that in the real probe path.
            f"pastis_planteur_bal10_ws{_ws}_ps1_sentinel2": _pastis_ps1_task(
                [Modality.SENTINEL2_L2A.name],
                window_size=_ws,
                dataset="pastis_planteur_bal10",
            ),
            f"pastis_planteur_bal10_full_ws{_ws}_ps1_sentinel2": _pastis_ps1_task(
                [Modality.SENTINEL2_L2A.name],
                window_size=_ws,
                dataset="pastis_planteur_bal10_full",
            ),
            f"pastis_planteur_bal25_ws{_ws}_ps1_sentinel2": _pastis_ps1_task(
                [Modality.SENTINEL2_L2A.name],
                window_size=_ws,
                dataset="pastis_planteur_bal25",
            ),
            f"pastis_planteur_bal25_full_ws{_ws}_ps1_sentinel2": _pastis_ps1_task(
                [Modality.SENTINEL2_L2A.name],
                window_size=_ws,
                dataset="pastis_planteur_bal25_full",
            ),
            f"pastis_planteur_bal100_ws{_ws}_ps1_sentinel2": _pastis_ps1_task(
                [Modality.SENTINEL2_L2A.name],
                window_size=_ws,
                dataset="pastis_planteur_bal100",
            ),
            f"pastis_planteur_bal100_full_ws{_ws}_ps1_sentinel2": _pastis_ps1_task(
                [Modality.SENTINEL2_L2A.name],
                window_size=_ws,
                dataset="pastis_planteur_bal100_full",
            ),
            f"pastis_planteur_bal1000_ws{_ws}_ps1_sentinel2": _pastis_ps1_task(
                [Modality.SENTINEL2_L2A.name],
                window_size=_ws,
                dataset="pastis_planteur_bal1000",
            ),
            f"pastis_planteur_bal1000_full_ws{_ws}_ps1_sentinel2": _pastis_ps1_task(
                [Modality.SENTINEL2_L2A.name],
                window_size=_ws,
                dataset="pastis_planteur_bal1000_full",
            ),
            f"pastis_planteur_plo10_ws{_ws}_ps1_sentinel2": _pastis_ps1_task(
                [Modality.SENTINEL2_L2A.name],
                window_size=_ws,
                dataset="pastis_planteur_plo10",
            ),
            f"pastis_planteur_plo10_full_ws{_ws}_ps1_sentinel2": _pastis_ps1_task(
                [Modality.SENTINEL2_L2A.name],
                window_size=_ws,
                dataset="pastis_planteur_plo10_full",
            ),
            f"pastis_planteur_plo25_ws{_ws}_ps1_sentinel2": _pastis_ps1_task(
                [Modality.SENTINEL2_L2A.name],
                window_size=_ws,
                dataset="pastis_planteur_plo25",
            ),
            f"pastis_planteur_plo25_full_ws{_ws}_ps1_sentinel2": _pastis_ps1_task(
                [Modality.SENTINEL2_L2A.name],
                window_size=_ws,
                dataset="pastis_planteur_plo25_full",
            ),
            f"pastis_planteur_plo100_ws{_ws}_ps1_sentinel2": _pastis_ps1_task(
                [Modality.SENTINEL2_L2A.name],
                window_size=_ws,
                dataset="pastis_planteur_plo100",
            ),
            f"pastis_planteur_plo100_full_ws{_ws}_ps1_sentinel2": _pastis_ps1_task(
                [Modality.SENTINEL2_L2A.name],
                window_size=_ws,
                dataset="pastis_planteur_plo100_full",
            ),
            f"pastis_planteur_plo1000_ws{_ws}_ps1_sentinel2": _pastis_ps1_task(
                [Modality.SENTINEL2_L2A.name],
                window_size=_ws,
                dataset="pastis_planteur_plo1000",
            ),
            f"pastis_planteur_plo1000_full_ws{_ws}_ps1_sentinel2": _pastis_ps1_task(
                [Modality.SENTINEL2_L2A.name],
                window_size=_ws,
...
FT_EVAL_TASKS = {
    ...
    "pastis_planteur_x10_ft_ws16_ps1_sentinel2": _pastis_ft_task(
        [Modality.SENTINEL2_L2A.name], dataset="pastis_planteur_x10"
    ),
    "pastis_planteur_x25_ft_ws16_ps1_sentinel2": _pastis_ft_task(
        [Modality.SENTINEL2_L2A.name], dataset="pastis_planteur_x25"
    ),
    "pastis_planteur_x50_ft_ws16_ps1_sentinel2": _pastis_ft_task(
        [Modality.SENTINEL2_L2A.name], dataset="pastis_planteur_x50"
    ),
    ...
    "pastis_planteur_px10_ft_ws16_ps1_sentinel2": _pastis_ft_task(
        [Modality.SENTINEL2_L2A.name], dataset="pastis_planteur_px10"
    ),
    "pastis_planteur_px25_ft_ws16_ps1_sentinel2": _pastis_ft_task(
        [Modality.SENTINEL2_L2A.name], dataset="pastis_planteur_px25"
    ),
    "pastis_planteur_px100_ft_ws16_ps1_sentinel2": _pastis_ft_task(
        [Modality.SENTINEL2_L2A.name], dataset="pastis_planteur_px100"
    ),
    ...
    # ---- window size 64 at patch size 4 ----
    # The configuration the fine-tune guidance calls for: PASTIS-style windows at
    # ps4/ws64. This yields 256 tokens per tile, the same as the published ws16/ps1
    ...
    "pastis2_drom_bg8_ft_ws16_ps1_sentinel1_sentinel2_landsat": _pastis_ft_task(
        [Modality.SENTINEL1.name, Modality.SENTINEL2_L2A.name, Modality.LANDSAT.name],
        dataset="pastis2_drom_bg8_s1s2ls",
    ),
    "m_eurosat": DownstreamTaskConfig(
        dataset="m-eurosat",
        ft_batch_size=64,
...
for _loio_terr in ("reunion", "guadeloupe", "martinique", "guyane", "mayotte"):
    ...
    # ws64/ps4 LOIO siblings (the fine-tune guidance configuration).
...
for _fs_ds in (
    ...
    FT_EVAL_TASKS[f"pastis_planteur_{_fs_ds}_ft_ws64_ps4_sentinel2"] = _pastis_ft_task(
        [Modality.SENTINEL2_L2A.name],
        dataset=f"pastis_planteur_{_fs_ds}",
        window_size=64,
        patch_size=4,
