...
serves v1/v1.1), but the v2 student weights + inference code are public (vendored
under evals/models/tessera). This module reproduces their pipeline on top of
