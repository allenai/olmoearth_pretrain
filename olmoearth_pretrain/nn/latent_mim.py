...
class LatentMIM(nn.Module, DistributedMixins):
    ...
    def forward(
        ...
        histogram_predictions = output_dict.pop("histogram_predictions", None)
        ...
        if histogram_predictions is not None:
            extra_metrics["histogram_predictions"] = histogram_predictions
        reconstructed = None
