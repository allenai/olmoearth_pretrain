"""FAO ICC crop taxonomy name->code mapping for Sen4AgriNet (S4A).

Vendored verbatim from the S4A repo (github.com/Orion-AI-Lab/S4A, utils/encodings_en.py).
The dataset labels raster stores these integer codes; code 0 (absent here) is the
no-declaration/nodata background. 168 codes total (< 254, so all fit in a uint8 class map).
"""
