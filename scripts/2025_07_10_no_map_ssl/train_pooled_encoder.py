...
def build_model_config(common: CommonComponents) -> LatentMIMConfig:
    ...
    encoder_config = EncoderAttnPoolConfig(
...
def build_trainer_config(common: CommonComponents) -> TrainerConfig:
    ...
    EVAL_TASKS = {
        # "m-eurosat-encoder-modality": DownstreamTaskConfig(
        #     dataset="m-eurosat",
        ...
        #     eval_interval=Duration.steps(4),
        # ),
        ...
        #     pooling_type=PoolingType.MEAN,
        #     norm_stats_from_pretrained=True,
        #     eval_interval=Duration.steps(6),
        # ),
        "pastis_encoder_modality": DownstreamTaskConfig(
            dataset="pastis",
        ...
        #     epochs=50,
        # ),
        # "sickle_landsat_encoder_modality": DownstreamTaskConfig(
        #     dataset="sickle",
        #     embedding_batch_size=32,
        #     probe_batch_size=16,
        #     num_workers=2,
        #     pooling_type=PoolingType.ENCODER_MODALITY,
        #     norm_stats_from_pretrained=True,
        #     probe_lr=0.01,
        #     eval_interval=Duration.epochs(10),
        ...
        #     epochs=50,
        # ),
        # "sickle_sentinel1_landsat_encoder_modality": DownstreamTaskConfig(
        #     dataset="sickle",
        #     embedding_batch_size=32,
        #     probe_batch_size=16,
        #     num_workers=2,
