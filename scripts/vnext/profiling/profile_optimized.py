"""Profile optimized training setup: linear patch embed + vectorized masked-neg loss.

Usage:
    # Dry run
    python scripts/vnext/profiling/profile_optimized.py dry_run profile_optimized local

    # Run with profiler
    python scripts/vnext/profiling/profile_optimized.py <CMD> profile_optimized <CLUSTER>

Based on gabi/masking-v2 base_band_dropout_no_s1_drop_random_time.py with:
- Linear patch embedding (use_linear_patch_embed=True, default)
- Vectorized masked-negatives loss (modality_patch_discrimination_masked_negatives_vec)
...
def build_trainer_config(common: CommonComponents) -> TrainerConfig:
    wandb_callback = OlmoEarthWandBCallback(
        ...
        project="2026_04_15_profile_optimized",
