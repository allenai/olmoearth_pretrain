"""Per-modality capacity experiment based on hidden1.py.

This keeps the hidden1 setup: ViT-base shallow decoder sizing, single-bandset
S2/Landsat tokenization, random band dropout for S2/Landsat, and one hidden
layer in the initial patch projection.
"""
...
def build_trainer_config(common: CommonComponents) -> TrainerConfig:
    ...
    WANDB_PROJECT = "2026_06_08_per_modality_capacity"
