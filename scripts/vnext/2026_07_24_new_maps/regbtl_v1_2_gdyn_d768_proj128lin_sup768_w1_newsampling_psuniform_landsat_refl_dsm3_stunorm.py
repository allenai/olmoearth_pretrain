...
linear student's output. Teacher, sampler, supervision, distillation terms,
...
MODULE_PATH = (
    ...
    "_landsat_refl_dsm3_stunorm.py"
)


def build_model_config(common: CommonComponents) -> LatentMIMConfig:
    """d768 teacher + linear [128, 64] student, sup768, new maps + dsm3, student LayerNorm."""
