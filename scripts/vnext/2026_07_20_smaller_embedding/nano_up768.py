"""Approach 2: native nano (128) encoder, loss target projected up to 768.

The ViT-nano transformer runs at its native 128-d width and emits a 128-d
deliverable embedding. The decoder predicts at 768, and the frozen exit-0 target
is the 128-d patch-embedding expanded to 768 by a frozen MLP, so the
patch-discrimination loss runs at 768.
"""
...
MODULE_PATH = "scripts/vnext/2026_07_20_smaller_embedding/nano_up768.py"
...
def build_train_module_config(
    ...
    """Faster train module with the nano-size optimizer settings."""
...
def build_model_config(common: CommonComponents) -> LatentMIMConfig:
    """Native nano (128) encoder, 768-d loss/target via frozen expander."""
