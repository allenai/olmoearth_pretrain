"""3-bandset + NO band dropout + random time with decode masking.

Same as base_3bandset_band_dropout_random_time.py but without band dropout.
Controls for the effect of band dropout in the 3-bandset setting.
...
def build_model_config(common: CommonComponents) -> LatentMIMConfig:
    """Build model without band dropout."""
