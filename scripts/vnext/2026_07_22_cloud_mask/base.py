...
def build_size_model_config(
    ...
    """Build a plain v1.2 (mixed 3D RoPE) model config for the given size preset.

    Standard latent-MIM: encoder, decoder and frozen target all at the native
    encoder width (no smaller-embedding bottleneck / expander).
    """
...
def build_model_config(common: CommonComponents) -> LatentMIMConfig:
    """Default base model config (base encoder, decoder depth 4)."""
