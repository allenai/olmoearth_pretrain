...
r"""ViT-B MAE with scaling-style downstream evals and embedding diagnostics.

Launch:
    python3 scripts/vnext/mae_scaling/base_mae.py dry_run run_name local

    python3 scripts/vnext/mae_scaling/base_mae.py launch run_name ai2/jupiter \
        --launch.num_gpus=8 \
