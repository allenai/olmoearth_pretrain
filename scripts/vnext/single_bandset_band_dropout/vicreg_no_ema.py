"""VICReg views WITHOUT EMA: ablation to test whether EMA is needed with VICReg.

Same as base_band_dropout_vicreg_views except ema_decay=(1.0, 1.0) (no momentum teacher).
