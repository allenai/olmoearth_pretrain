"""Pooled target alignment experiment: adds MSE between student and target pooled representations.

Same setup as base_band_dropout_vicreg_views plus pooled_target_align_weight=1.0,
which adds an MSE loss aligning the student's global pooled embedding with the
EMA target encoder's global pooled embedding.
"""
