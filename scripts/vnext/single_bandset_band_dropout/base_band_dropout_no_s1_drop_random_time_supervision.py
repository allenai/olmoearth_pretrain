"""Base script for single bandset + random band dropout (no S1) + random time with decode masking + masked-negatives loss + supervision.
...
- Supervision head on decode-only modalities with weight 0.01
"""
