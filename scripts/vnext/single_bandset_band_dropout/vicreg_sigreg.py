"""SigReg experiment: replace VICReg with SIGReg (sliced characteristic-function Gaussian matching).

Same setup as base_band_dropout_vicreg_views except vicreg_views_config uses SIGReg
instead of vicreg_views. InfoNCE kept as-is.
"""
