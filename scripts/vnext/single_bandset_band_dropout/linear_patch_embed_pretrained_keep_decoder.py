"""Linear patch embed initialised from a pretrained checkpoint (keep decoder).
...
are loaded.  Decoder weights are kept from the checkpoint.

See linear_patch_embed_pretrained_reinit_decoder.py for the variant that
