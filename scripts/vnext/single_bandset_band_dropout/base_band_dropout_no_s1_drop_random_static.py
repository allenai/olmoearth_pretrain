"""Base script with static multi-frequency sinusoidal encodings.

Same as base_band_dropout_no_s1_drop_random.py but with:
- Static temporal encoding (multi-frequency fractional year)
- Static spatial encoding (per-token lat/lon on unit sphere)
- Dimension layout: [channel(25%) | temporal(25%) | spatial(50%)]
