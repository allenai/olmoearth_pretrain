"""Patch-level var+cov WITHOUT EMA: ablation to test whether EMA is needed with patch VICReg.

Same as vicreg_patch_varcov_sat except ema_decay=(1.0, 1.0) (no momentum teacher).
All other hyperparameters identical for clean comparison.
"""
