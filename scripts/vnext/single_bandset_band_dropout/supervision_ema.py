"""Pixel supervision on decode-only modalities WITH EMA, no VICReg.

Tests whether pixel-level supervision on map modalities (worldcover, SRTM, OSM,
canopy height, CDL, worldcereal) helps when combined with EMA (0.996→1.0).
No VICReg regularization — pure supervision + MIM + InfoNCE + EMA.
"""
