"""Single bandset + band dropout + random time, with the Hyperball optimizer.

Identical to base_band_dropout_no_s1_drop_random_time.py except the AdamW
optimizer is replaced by Hyperball (Wen et al. 2025): explicit Frobenius-norm
projection on weight matrices in place of weight decay.
...
from olmoearth_pretrain.train.optim import HyperballConfig
