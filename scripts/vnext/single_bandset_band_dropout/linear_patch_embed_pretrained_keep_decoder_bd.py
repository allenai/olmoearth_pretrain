"""Linear patch embed + constant band dropout from a pretrained checkpoint (keep decoder).
...
from a pretrained checkpoint.  Decoder weights are kept from the checkpoint.
