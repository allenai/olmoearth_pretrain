"""VICReg 0.01x weight sweep with EMA: VICReg views + patch varcov.

Tests whether 100x lower weights are compatible with EMA (0.996→1.0).
VICReg: inv=0.001, var=0.001, cov=0.0001. PatchVC: var=0.0005, cov=0.00005.
Control — if this still hurts EMA, the problem isn't weight magnitude.
"""
