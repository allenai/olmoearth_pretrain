"""Multi-level supervision experiment: adds MSE loss at intermediate encoder depths.

Same setup as base_band_dropout_vicreg_views plus multi-level supervision
at depth 6 (mid-encoder) with weight=1.0. Both student and target pooled
intermediate representations are compared via MSE, inspired by VJEPA 2.1.
"""
