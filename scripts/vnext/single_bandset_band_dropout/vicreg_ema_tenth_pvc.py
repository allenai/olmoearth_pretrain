"""VICReg 0.1x weight sweep with EMA: VICReg views + patch varcov.

Tests whether 10x lower weights are compatible with EMA (0.996→1.0).
VICReg: inv=0.01, var=0.01, cov=0.001. PatchVC: var=0.005, cov=0.0005.
"""
