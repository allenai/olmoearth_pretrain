"""VICReg 0.1x weight sweep with EMA: VICReg views only.

Tests whether 10x lower VICReg weights (inv=0.01, var=0.01, cov=0.001) are
compatible with EMA (0.996→1.0). No patch varcov.
"""
