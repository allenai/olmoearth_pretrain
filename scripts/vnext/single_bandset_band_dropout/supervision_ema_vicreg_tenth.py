"""Pixel supervision + 0.1x VICReg + 0.1x PatchVC WITH EMA.

Combines pixel-level supervision on map modalities with low-weight VICReg views
(inv=0.01, var=0.01, cov=0.001) and patch varcov (var=0.005, cov=0.0005),
plus EMA (0.996→1.0).
"""
