"""VICReg sweep: no variance term (inv=0.1, var=0.0, cov=0.01). Tests whether variance regularization is the key ingredient."""
...
def build_trainer_config(common: CommonComponents) -> TrainerConfig:
    ...
    WANDB_PROJECT = "2026_04_10_vicreg_views"
