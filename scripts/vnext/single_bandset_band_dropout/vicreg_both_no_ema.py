"""VICReg views + patch var+cov WITHOUT EMA: combined regularization ablation.

Combines pooled VICReg views (inv=0.1, var=0.1, cov=0.01) with patch-level
variance+covariance (var=0.05, cov=0.005) on satellite modalities, no EMA.
"""
