"""Supervision + EMA with MAP modalities excluded from target encoder.

Same as base_band_dropout_no_s1_drop_random_time_supervision but with:
- EMA enabled (0.996 → 1.0 linear ramp)
- Decode-only (MAP) modalities excluded from the EMA target encoder
- Embedding diagnostics on m-eurosat + pretrain_subset
"""
...
def build_train_module_config(
    ...
    return ContrastiveLatentMIMTrainModuleConfig(
        ...
        ema_decay=(0.996, 1.0),
        unmask_exclude_modalities=ONLY_DECODE_MODALITIES,
...
def build_trainer_config(common: CommonComponents) -> TrainerConfig:
    ...
    WANDB_PROJECT = "2026_04_supervision_no_maps_ema"
    ...
    H5PY_DIR = "/weka/dfive-default/helios/dataset/osm_sampling/h5py_data_w_missing_timesteps_zstd_3_128_x_4/cdl_gse_landsat_openstreetmap_raster_sentinel1_sentinel2_l2a_srtm_worldcereal_worldcover_worldpop_wri_canopy_height_map/1138828"
    EVAL_TASKS = {
        "pretrain_embed_diag": DownstreamTaskConfig(
