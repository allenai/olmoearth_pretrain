"""Base script for single bandset + random band dropout (no S1) + latlon encoding + unified timestamp encoding.
...
- Lat/lon encoding with 50% dropout
- Unified timestamp encoding (sinusoidal day+month+year)
"""
