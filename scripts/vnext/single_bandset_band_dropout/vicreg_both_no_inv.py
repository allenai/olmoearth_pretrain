"""Both regularizations (VICReg views + patch var+cov), no invariance, slow EMA.

Pooled VICReg views with inv=0 (var+cov only) plus patch-level var+cov on
satellite modalities. EMA starts at 0.999 for a slower, more stable target.
"""
