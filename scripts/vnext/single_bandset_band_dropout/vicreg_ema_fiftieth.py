"""VICReg 0.02x weight sweep with EMA: VICReg views + patch varcov.

Tests whether 50x lower weights are compatible with EMA (0.996→1.0).
VICReg: inv=0.002, var=0.002, cov=0.0002. PatchVC: var=0.001, cov=0.0001.
"""
