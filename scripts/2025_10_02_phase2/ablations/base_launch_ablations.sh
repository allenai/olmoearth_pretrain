...
# random masking
python scripts/2025_10_02_phase2/ablations/base_random_masking.py launch phase2.0_base_random_fixed_modality_masking ai2/ceres-cirrascale --launch.clusters='[ai2/jupiter-cirrascale-2,ai2/ceres-cirrascale]' --launch.priority=high --trainer.callbacks.wandb.project=2025_10_08_phase2_ablations
# MAE
