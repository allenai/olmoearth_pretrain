...
These Settings are derived from the 20250321 latentmim_tiny_sweep. We identified the best settings for classification and segmentation, and applied them to the galileo model.
"""
...
def build_train_module_config(
    ...
    # a for classification, b for segmentation
    ...
    token_exit_cfg_a = {modality: 0 for modality in common.supported_modality_names}
    token_exit_cfg_b = {modality: 6 for modality in common.supported_modality_names}
