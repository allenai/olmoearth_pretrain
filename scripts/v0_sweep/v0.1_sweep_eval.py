...
# scripts/v0_sweep/contrastive_latent_mim_st.py train favyencheck_base_wattn_latentmim_contrastive_random_0 ai2/ceres-cirrascale --train_module.masking_config.strategy_config.type=random --common.launch.num_gpus=8 --model.reconstructor_config=null --data_loader.token_budget=3000 --train_module.rank_microbatch_size=16 --train_module.mae_loss_config=null --train_module.ema_decay=[1,1] --launch.priority=high --model.encoder_config.windowed_attention_size=3 --model.decoder_config.windowed_attention_size=3 --model.encoder_config.supported_modality_names=[sentinel2_l2a,sentinel1,worldcover,srtm,landsat,openstreetmap_raster] --model.decoder_config.supported_modality_names=[sentinel2_l2a,sentinel1,worldcover,srtm,landsat,openstreetmap_raster]

base_cmd = (
    "python scripts/v0_sweep/contrastive_latent_mim_st.py launch favyencheck_base_wattn_latentmim_contrastive_random_0_all_evals_0_{lr} ai2/titan-cirrascale "
    "--train_module.masking_config.strategy_config.type=random --common.launch.num_gpus=1 "
    "--model.reconstructor_config=null --data_loader.token_budget=3000 "
    "--train_module.rank_microbatch_size=16 --train_module.mae_loss_config=null "
    "--train_module.ema_decay=[1,1] "
    "--model.encoder_config.windowed_attention_size=3 --model.decoder_config.windowed_attention_size=3 "
    "--trainer.load_path=/weka/dfive-default/helios/checkpoints/favyen/favyencheck_base_wattn_latentmim_contrastive_random_0/step55000 "
)
