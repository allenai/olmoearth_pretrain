...
# base_cmd = (
#     "python scripts/v0_sweep/contrastive_latent_mim_st.py launch v0.1_base_SpT_latentmim_contrastive_space_time_all_evals_{lr} ai2/titan-cirrascale "
#     "--model.decoder_config.depth=4 --common.launch.num_gpus=1 "
#     "--train_module.masking_config.strategy_config.type=space_time "
#     "--model.reconstructor_config=null --train_module.mae_loss_config=null "
#     "--data_loader.token_budget=3000 --train_module.rank_microbatch_size=16 --train_module.ema_decay=[1,1] "
#     "--trainer.load_path=/weka/dfive-default/helios/checkpoints/joer/v0.1_base_SpT_latentmim_contrastive_space_time/step139500 "
# )
...
# base_cmd = (
#     "python scripts/v0_sweep/galileo.py launch v0.1_base_galileo_random_x_cross_space_time_all_evals_{lr} ai2/titan-cirrascale "
#     "--model.decoder_config.depth=4 --common.launch.num_gpus=1 "
#     "--train_module.masking_config_a.strategy_config.type=modality_cross_space_time "
#     "--model.reconstructor_config=null --train_module.mae_loss_config=null "
#     "--train_module.contrastive_config=null --train_module.ema_decay=[1,1] "
#     "--trainer.load_path=/weka/dfive-default/helios/checkpoints/joer/v0.1_base_galileo_random_x_cross_space_time/step192250 "
# )
...
base_cmd = (
    "python scripts/v0_sweep/galileo.py launch v0.1_base_galileo_random_x_cross_space_time_ema_all_evals_{lr} ai2/titan-cirrascale "
    "--model.decoder_config.depth=4 --common.launch.num_gpus=1 "
    "--train_module.masking_config_a.strategy_config.type=modality_cross_space_time "
    "--model.reconstructor_config=null --train_module.mae_loss_config=null "
    "--train_module.contrastive_config=null "
    "--trainer.load_path=/weka/dfive-default/helios/checkpoints/joer/v0.1_base_galileo_random_x_cross_space_time_ema/step213000 "
)
