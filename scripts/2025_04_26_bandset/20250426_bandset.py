"""Script for running bandset experiments."""
...
BASE_COMMAND = (
    "python3 scripts/2025_04_26_bandset/20250426_galileo_base.py launch {run_name} ai2/jupiter-cirrascale-2 "
...
for decoder_depth in DECODER_DEPTHS:
    for lr in LEARNING_RATES:
        for contrastive_weight in CONTRASTIVE_WEIGHTS:
            run_name = f"galileo_bandset_base_decoder_{decoder_depth}_lr_{lr}_weight_{contrastive_weight}"
