...
python scripts/v0.2_sweep/latent_mim_128_tiny.py launch v0.2_latent_mim_128_space_time_sen2_tiny ai2/titan-cirrascale --launch.priority=low --common.training_modalities=\[sentinel2_l2a,\] --common.launch.num_gpus=1
python scripts/v0.2_sweep/latent_mim_128_tiny.py launch v0.2_latent_mim_128_space_time_sen2_sen1_tiny ai2/titan-cirrascale --launch.priority=low --common.training_modalities=\[sentinel2_l2a,sentinel1,\] --common.launch.num_gpus=1
python scripts/v0.2_sweep/latent_mim_128_tiny.py launch v0.2_latent_mim_128_space_time_sen2_sen1_landsat_srtm_latlon_tiny ai2/titan-cirrascale --launch.priority=low --common.training_modalities=\[sentinel2_l2a,sentinel1,landsat,srtm,latlon\] --common.launch.num_gpus=1
python scripts/v0.2_sweep/latent_mim_128_tiny.py launch v0.2_latent_mim_128_space_time_sen2_sen1_landsat_srtm_latlon_worldcover_osm_tiny ai2/titan-cirrascale --launch.priority=low --common.training_modalities=\[sentinel2_l2a,sentinel1,landsat,srtm,latlon,worldcover,openstreetmap_raster\] --common.launch.num_gpus=1
