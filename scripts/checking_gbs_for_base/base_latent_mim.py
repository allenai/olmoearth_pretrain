...
def build_model_config(common: CommonComponents) -> LatentMIMConfig:
    ...
    model_size_args = MODEL_SIZE_ARGS["base_super_shallow_decoder"]
    ENCODER_EMBEDDING_SIZE = int(model_size_args["encoder_embedding_size"])
    DECODER_EMBEDDING_SIZE = int(model_size_args["decoder_embedding_size"])
    ENCODER_DEPTH = int(model_size_args["encoder_depth"])
    DECODER_DEPTH = int(model_size_args["decoder_depth"])
    ENCODER_NUM_HEADS = int(model_size_args["encoder_num_heads"])
    DECODER_NUM_HEADS = int(model_size_args["decoder_num_heads"])
    MLP_RATIO = float(model_size_args["mlp_ratio"])
...
def build_dataset_config(common: CommonComponents) -> HeliosDatasetConfig:
    ...
    h5py_dir = "/weka/dfive-default/helios/dataset/presto/h5py_data_test_chunking_2_2_2/landsat_naip_openstreetmap_raster_sentinel1_sentinel2_l2a_srtm_worldcover/50000"
