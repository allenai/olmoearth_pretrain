"""Experiment with text-embedding targets for map modalities.
...
from olmoearth_pretrain.nn.text_targets import TextEmbeddingTargetConfig
...
def build_train_module_config(
    ...
    """Build the train module config with text embedding targets."""
    return ContrastiveLatentMIMTrainModuleConfig(
        ...
        text_target_config=TextEmbeddingTargetConfig(
