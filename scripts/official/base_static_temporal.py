"""vnext base with static_temporal encoding: legacy spatial, multi-frequency temporal.

Same as vnext/single_bandset_band_dropout/base_band_dropout_no_s1_drop_random_static.py
but with timestamp_encoding_mode="static_temporal" instead of "static", so:
...
def build_trainer_config(common: CommonComponents) -> TrainerConfig:
    ...
    WANDB_PROJECT = "2026_04_06_static_temporal_encoding"
