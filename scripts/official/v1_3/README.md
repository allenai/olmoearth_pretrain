...
| `ablations/pure_perceiver_joint_latentread_rstride.py` | pixel-latent latentread at random latent strides (pixel to patch) under a 4,096-latent budget; no pixel-side cap |
