"""SPEED copy of ``pure_perceiver_joint_latentread_rstride.py``: compiled RoPE.
...
essentially identically to ``v1_3_vit0_rstride_ps8_lb512_latentread_joint12``;
...
``v1_3_vit0_rstride_ps8_lb512_fast2_latentread_joint12`` (``fast`` hit
``recompile_limit`` and ran eager).
"""
...
MODULE_PATH = (
    "scripts/official/v1_3/ablations/pure_perceiver_joint_latentread_rstride_fast.py"
)


def build_model_config(common: CommonComponents) -> LatentMIMConfig:
    """The point-latent random-stride arm with the compiled RoPE op."""
    ...
    assert not perceiver.latent_time_range and not perceiver.latent_spatial_range
