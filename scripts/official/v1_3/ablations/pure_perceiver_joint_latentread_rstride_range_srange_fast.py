"""SPEED copy of ``pure_perceiver_joint_latentread_rstride_range_srange.py``: compiled RoPE.
...
essentially identically to ``v1_3_vit0_rstride_ps8_lb512_srange_latentread_rangerope_joint12``;
...
``v1_3_vit0_rstride_ps8_lb512_fast_srange_latentread_rangerope_joint12``.
"""
...
MODULE_PATH = (
    ...
    "pure_perceiver_joint_latentread_rstride_range_srange_fast.py"
)


def build_model_config(common: CommonComponents) -> LatentMIMConfig:
    """The interval + footprint random-stride arm with the compiled RoPE op."""
    ...
    assert perceiver.latent_time_range and perceiver.latent_spatial_range
