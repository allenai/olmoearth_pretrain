r"""Launch script: v1.3 recipe + open-set supervised probe, open-set dataset only.

Trains the v1.3 model from scratch on the open-set supervised dataset alone (the
~1.4M label-bank windows), with the open-set probe loss added to the latent-MIM,
map supervision and student distillation losses. See ``open_set_base.py`` for the
...
MODULE_PATH = "scripts/official/v1_3/open_set_only.py"
