"""PASTIS finetuning baseline with tiny model (no APT).

Usage:
    python scripts/official/apt/pastis_eval_tiny.py evaluate \
        pastis_baseline_p4 local \
        --trainer.load_path=/weka/dfive-default/helios/checkpoints/joer/tiny_lr0.0002_wd0.02/step360000

    # Override patch size (2, 4, or 8)
    --trainer.callbacks.downstream_evaluator.tasks.pastis_finetune.patch_size=8
"""
...
if __name__ == "__main__":
    logger.info("PASTIS baseline (no APT) — patch_size overrideable via CLI")
    main(
