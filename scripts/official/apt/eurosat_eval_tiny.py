"""EuroSAT finetuning evaluation with tiny model (no APT baseline).
...
Usage:
    ...
    python scripts/official/apt/eurosat_eval_tiny.py evaluate \
        eurosat_eval_tiny local \
    ...
    python scripts/official/apt/eurosat_eval_tiny.py evaluate \
        ...
        --trainer.callbacks.downstream_evaluator.tasks.m_eurosat_finetune.patch_size=8
"""
...
if __name__ == "__main__":
    logger.info("Using TINY model configuration (no APT) for EuroSAT")
