"""Base model ablation encoding and decoding all modalities using random masking.

Uses random masking instead of modality_cross_random to ensure all modalities
are always encoded on every rank (avoids FSDP sync issues).
"""
...
def build_train_module_config(
    ...
    return ContrastiveLatentMIMTrainModuleConfig(
        ...
        # Random masking: all modalities always encoded, just with random token masks
