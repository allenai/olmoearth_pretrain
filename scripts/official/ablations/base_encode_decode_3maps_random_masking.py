"""Base model ablation encoding and decoding 3 maps with random masking.

Uses random masking with only satellite + 3 map modalities (srtm, worldcover, osm).
Combines both fixes: fewer modalities AND random masking for max safety.
"""
...
def build_train_module_config(
    ...
    return ContrastiveLatentMIMTrainModuleConfig(
        ...
        # Random masking: all modalities always encoded
