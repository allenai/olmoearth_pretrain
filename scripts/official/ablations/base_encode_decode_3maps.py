"""Base model ablation encoding and decoding 3 map modalities (srtm, worldcover, osm).

Uses fewer modalities to reduce chance of FSDP sync issues from modality dropout.
Only satellite modalities (s2, s1, landsat) + 3 maps (srtm, worldcover, osm).
"""
...
def build_common_components(
    ...
    # Only 6 modalities: 3 satellite + 3 maps
...
def build_train_module_config(
    ...
    return ContrastiveLatentMIMTrainModuleConfig(
        ...
        # No only_decode_modalities - all 6 modalities can be encoded and decoded
