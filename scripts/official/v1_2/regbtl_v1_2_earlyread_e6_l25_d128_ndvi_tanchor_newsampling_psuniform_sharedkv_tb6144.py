"""EARLY READ + SHARED K/V + DOUBLED BUDGET: 6-layer trunk, 25 blocks, tb 6144.

``regbtl_v1_2_earlyread_e6_l25_d128_ndvi_tanchor_newsampling_psuniform_sharedkv`` at
...
MODULE_PATH = (
    ...
    "regbtl_v1_2_earlyread_e6_l25_d128_ndvi_tanchor_newsampling_psuniform_sharedkv_tb6144.py"
)
