"""EARLY READ: 3-layer trunk + 24 bottleneck blocks, token budget 6144.

Replaces ``regbtl_v1_2_earlyread_e3_l35_d128_ndvi_tanchor_newsampling_psuniform_tb6144``, which OOM'd on every attempt.
That arm was solved for exact parameter parity with the 12+4 base (121.02M) and needed
35 blocks to get there; at micro 64 it exceeded 80 GB and a rank died at step 6,
...
MODULE_PATH = (
    ...
    "regbtl_v1_2_earlyread_e3_l24_d128_ndvi_tanchor_newsampling_psuniform_tb6144.py"
)
