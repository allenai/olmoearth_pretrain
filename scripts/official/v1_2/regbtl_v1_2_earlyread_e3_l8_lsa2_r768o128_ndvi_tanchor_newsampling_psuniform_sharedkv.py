"""LSA 1:2 AT FIXED READ COUNT: 3-layer trunk, 8 reads, 4 LSA blocks (768 -> 128).
...
fall.
    ...
    e3_l8_lsa2 (1:2)       8    4      15  126.50M  122.9 G

Its sibling ``e3_l11_lsa2`` answers the other half: it raises the read count until
...
MODULE_PATH = (
    ...
    "regbtl_v1_2_earlyread_e3_l8_lsa2_r768o128_ndvi_tanchor_newsampling_psuniform_sharedkv.py"
)


def build_model_config(common: CommonComponents) -> LatentMIMConfig:
    """3-layer trunk, 8 reads at 768 with one LSA per two, projected to 128."""
