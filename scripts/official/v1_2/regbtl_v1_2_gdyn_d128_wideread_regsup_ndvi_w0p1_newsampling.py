"""d128 wideread + regsup + NDVI (w0p1, newsampling) with the time-free register read.

``regbtl_v1_2_gdyn_d128_wideread_regsup_w0p1_newsampling`` plus the
...
Identical to ``regbtl_v1_2_gdyn_d128_wideread_regsup_ndvi_w0p1_tanchor_newsampling``
minus the temporally-anchored register read, isolating the NDVI arm from the anchor.
"""
...
MODULE_PATH = (
    ...
    "regbtl_v1_2_gdyn_d128_wideread_regsup_ndvi_w0p1_newsampling.py"
)


def build_model_config(common: CommonComponents) -> LatentMIMConfig:
    """d128 wideread + regsup incl. time-conditioned NDVI, time-free register read."""
