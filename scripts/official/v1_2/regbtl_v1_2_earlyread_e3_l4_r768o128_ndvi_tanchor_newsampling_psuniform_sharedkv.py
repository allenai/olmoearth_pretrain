"""WIDE-AND-SHALLOW BOTTLENECK: 3-layer trunk, 4 blocks at 768, output 128.
...
a much more capable bottleneck. The measurement is self-interpreting: land near 4-block
...
MODULE_PATH = (
    ...
    "regbtl_v1_2_earlyread_e3_l4_r768o128_ndvi_tanchor_newsampling_psuniform_sharedkv.py"
)


def build_model_config(common: CommonComponents) -> LatentMIMConfig:
    """3-layer trunk + 4 blocks at 768, projected to 128 on output."""
