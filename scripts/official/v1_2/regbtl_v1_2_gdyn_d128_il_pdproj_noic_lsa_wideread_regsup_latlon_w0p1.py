"""v1.2 register bottleneck noic_lsa d128 wideread + register sup + latlon at 10x weight.

Identical to ``regbtl_v1_2_gdyn_d128_il_pdproj_noic_lsa_wideread_regsup_latlon.py``
except the supervision base weight is raised 10x (0.01 -> 0.1); the per-task balancing
...
MODULE_PATH = "scripts/official/v1_2/regbtl_v1_2_gdyn_d128_il_pdproj_noic_lsa_wideread_regsup_latlon_w0p1.py"


def build_model_config(common: CommonComponents) -> LatentMIMConfig:
    """d128 wideread + register supervision incl. latlon head, at the 10x (0.1) weight."""
