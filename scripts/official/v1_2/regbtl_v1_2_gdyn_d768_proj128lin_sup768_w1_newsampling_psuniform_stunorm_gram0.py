...
THIS CELL: gram=0, bare-Linear head. The Tessera-v2 recipe exactly -- per-prefix cosine and nothing else. Isolates whether Gram was ever doing anything at the shipped head depth.
"""
...
MODULE_PATH = "scripts/official/v1_2/regbtl_v1_2_gdyn_d768_proj128lin_sup768_w1_newsampling_psuniform_stunorm_gram0.py"
