"""d768 teacher + detached pcv student: 50/50 Gram mix + student supervision at 0.01x (arm: gramwithin_supstu0p01).
...
MODULE_PATH = (
    ...
    "regbtl_v1_2_gdyn_d768_proj128pcv_gramwithin_supstu0p01_w1_newsampling_psuniform.py"
)
