"""EARLY READ + SHARED K/V: 3-layer trunk + 12 bottleneck blocks.
...
(l12 vs its partner) is clean. They are NOT directly comparable to the earlier unshared
...
MODULE_PATH = (
    ...
    "regbtl_v1_2_earlyread_e3_l12_d128_ndvi_tanchor_newsampling_psuniform_sharedkv.py"
)
