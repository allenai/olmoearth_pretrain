"""LSA 1:2 AT PARAM PARITY: 6-layer trunk, 11 reads, 6 LSA blocks (768 -> 128).
...
extra reads, so the block count lands within one of the 1:1 arm (23 vs 22)
...
lateral mixing (LSA).
    ...
    e6_l11 (1:2)     11    6      23  179.66M  227.7 G
...
MODULE_PATH = (
    ...
    "regbtl_v1_2_earlyread_e6_l11_lsa2_r768o128_ndvi_tanchor_newsampling_psuniform_sharedkv.py"
)


def build_model_config(common: CommonComponents) -> LatentMIMConfig:
    """6-layer trunk, 11 reads at 768 with one LSA per two, projected to 128."""
