"""d768 teacher + detached pcv student: within-scene Gram + student supervision at 0.1x (ndvi + tanchor) (arm: gramonly_supstu0p1_flatlr).
...
ARM = STUDENT_ARMS["gramonly_supstu0p1_flatlr"]
MODULE_PATH = (
    "scripts/official/v1_2/"
    "regbtl_v1_2_gdyn_d768_proj128pcv_gramonly_supstu0p1_flatlr_ndvi_w1_tanchor_newsampling_psuniform.py"
)
