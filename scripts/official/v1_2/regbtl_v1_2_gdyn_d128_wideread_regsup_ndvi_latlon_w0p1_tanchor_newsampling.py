"""d128 wideread + regsup + NDVI + latlon (w0p1, newsampling), anchored register read.

``regbtl_v1_2_gdyn_d128_wideread_regsup_ndvi_w0p1_tanchor_newsampling`` with the
latlon location-regression arm added (unit-sphere xyz from the mean-pooled register
...
MODULE_PATH = (
    ...
    "regbtl_v1_2_gdyn_d128_wideread_regsup_ndvi_latlon_w0p1_tanchor_newsampling.py"
)
