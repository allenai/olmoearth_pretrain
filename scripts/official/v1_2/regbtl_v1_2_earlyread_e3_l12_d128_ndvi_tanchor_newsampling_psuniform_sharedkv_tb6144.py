"""EARLY READ + SHARED K/V + DOUBLED BUDGET: 3-layer trunk, 12 blocks, tb 6144.

``regbtl_v1_2_earlyread_e3_l12_d128_ndvi_tanchor_newsampling_psuniform_sharedkv`` at
...
MODULE_PATH = (
    ...
    "regbtl_v1_2_earlyread_e3_l12_d128_ndvi_tanchor_newsampling_psuniform_sharedkv_tb6144.py"
)


def build_model_config(common: CommonComponents) -> LatentMIMConfig:
    """3-layer trunk + 12 interleaved read/latent blocks over one shared K/V."""
