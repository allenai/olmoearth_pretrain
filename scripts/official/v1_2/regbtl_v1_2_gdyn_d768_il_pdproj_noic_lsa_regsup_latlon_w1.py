"""v1.2 register bottleneck noic_lsa d768 + register supervision + latlon at 100x weight.
...
MODULE_PATH = (
    "scripts/official/v1_2/regbtl_v1_2_gdyn_d768_il_pdproj_noic_lsa_regsup_latlon_w1.py"
)


def build_model_config(common: CommonComponents) -> LatentMIMConfig:
    """d768 frontier + register supervision incl. latlon head, at the 100x (1.0) weight."""
