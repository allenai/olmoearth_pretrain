"""SMALL backbone, d384 teacher + detached perceiver [128, 64] student (pcv), supboth, w1, newsampling psuniform.

The small-backbone twin of
``regbtl_v1_2_gdyn_d768_proj128pcv_supboth_w1_newsampling_psuniform``. The v1.2 size
...
This arm: separate supervision heads on BOTH the d384 registers and the 128d student.
The A/B against the sup768 sibling isolates what supervision directly on the student
buys on top of distillation, at the small backbone.
...
MODULE_PATH = "scripts/official/v1_2/regbtl_v1_2_small_gdyn_d384_proj128pcv_supboth_w1_newsampling_psuniform.py"


def build_model_config(common: CommonComponents) -> LatentMIMConfig:
    """Small encoder, d384 teacher + detached perceiver student, heads on both widths."""
