...
# supervision heads on {d768 only, both, 128d only} x student {linear, perceiver}, all at w0p1.
...
for ARCH in lin pcv; do
    for SUP in sup768 supboth sup128; do
        NAME="regbtl_v1_2_gdyn_d768_proj128${ARCH}_${SUP}_w0p1_newsamp_psuniform"
        SCRIPT="scripts/official/v1_2/regbtl_v1_2_gdyn_d768_proj128${ARCH}_${SUP}_w0p1_newsampling_psuniform.py"
