"""Gram ON, 2-layer MLP back-projection head (arm: mlpgram1).
...
THIS CELL: gram=1, 2-layer MLP head at H=256. The single-change test of head capacity, with Gram left at the family default.
"""
...
MODULE_PATH = "scripts/official/v1_2/regbtl_v1_2_gdyn_d768_proj128lin_sup768_w1_newsampling_psuniform_stunorm_mlpgram1.py"
...
def build_train_module_config(common: CommonComponents) -> LatentMIMTrainModuleConfig:
    ...
    # gram=1.0: the LatentMIMTrainModule default the base already uses
    return config
