"""LSA 1:2 AT PARAM PARITY: 6-layer trunk, 5 reads, 3 LSA blocks (768 -> 128).
...
extra reads, so the block count lands within one of the 1:1 arm (14 vs 14)
...
lateral mixing (LSA).
    ...
    e6_l5 (1:2)      5    3      14  122.96M  220.9 G
...
MODULE_PATH = (
    ...
    "regbtl_v1_2_earlyread_e6_l5_lsa2_r768o128_ndvi_tanchor_newsampling_psuniform_sharedkv.py"
)


def build_model_config(common: CommonComponents) -> LatentMIMConfig:
    """6-layer trunk, 5 reads at 768 with one LSA per two, projected to 128."""
