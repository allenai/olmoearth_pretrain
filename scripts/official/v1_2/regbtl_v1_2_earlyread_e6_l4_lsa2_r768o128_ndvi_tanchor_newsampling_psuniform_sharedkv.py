"""LSA 1:2 AT FIXED READ COUNT: 6-layer trunk, 4 reads, 2 LSA blocks (768 -> 128).

``regbtl_v1_2_earlyread_e6_l4_r768o128_ndvi_tanchor_newsampling_psuniform_sharedkv``
...
fall.
    ...
    e6_l4      (1:1)       4    4      14  124.14M  220.6 G
    e6_l4_lsa2 (1:2)       4    2      12  109.97M  219.4 G

Its sibling ``e6_l5_lsa2`` answers the other half: it raises the read count until
...
MODULE_PATH = (
    ...
    "regbtl_v1_2_earlyread_e6_l4_lsa2_r768o128_ndvi_tanchor_newsampling_psuniform_sharedkv.py"
)


def build_model_config(common: CommonComponents) -> LatentMIMConfig:
    """6-layer trunk, 4 reads at 768 with one LSA per two, projected to 128."""
