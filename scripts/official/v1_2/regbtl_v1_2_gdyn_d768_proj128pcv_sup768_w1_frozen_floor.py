"""Frozen d768 teacher, PERCEIVER student continued at a DECAYED (floor) LR.

The pcv counterpart of
``regbtl_v1_2_gdyn_d768_proj128lin_sup768_w1_frozen_floor``; see
...
MODULE_PATH = (
    "scripts/official/v1_2/regbtl_v1_2_gdyn_d768_proj128pcv_sup768_w1_frozen_floor.py"
)

# Where the parent's cosine schedule left the student: 10% of the 1e-4 peak.
STUDENT_LR = 1e-5
# ConstantWithWarmup divides by warmup_steps, so 1 is "no warmup".
NO_WARMUP_STEPS = 1
