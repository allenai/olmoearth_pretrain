"""LSA 1:2 AT PARAM PARITY: 3-layer trunk, 11 reads, 6 LSA blocks (768 -> 128).

``regbtl_v1_2_earlyread_e3_l8_r768o128_ndvi_tanchor_newsampling_psuniform_sharedkv``
...
8 to 11 so the parameter count matches.

WHAT THIS TESTS. Not speed. Holding parameters fixed, the LSA blocks removed are spent on
extra reads, so the block count lands within one of the 1:1 arm (20 vs 19)
...
lateral mixing (LSA).
    ...
    e3_l8 (1:1)      8    8      19  154.85M  125.2 G
    e3_l11 (1:2)     11    6      20  158.40M  126.6 G
...
IF SPEED IS THE GOAL INSTEAD: keep the read count at 8 and thin the LSA -- that gives
8 reads + 4 LSA and drops the block count outright, at fewer parameters.
"""
...
MODULE_PATH = (
    ...
    "regbtl_v1_2_earlyread_e3_l11_lsa2_r768o128_ndvi_tanchor_newsampling_psuniform_sharedkv.py"
)


def build_model_config(common: CommonComponents) -> LatentMIMConfig:
    """3-layer trunk, 11 reads at 768 with one LSA per two, projected to 128."""
