"""EARLY READ + SHARED K/V: 3-layer trunk + 35 bottleneck blocks.

``regbtl_v1_2_earlyread_e3_l35_d128_ndvi_tanchor_newsampling_psuniform`` with
...
(l35 vs its partner) is clean. They are NOT directly comparable to the earlier unshared
...
MODULE_PATH = (
    ...
    "regbtl_v1_2_earlyread_e3_l35_d128_ndvi_tanchor_newsampling_psuniform_sharedkv.py"
)
