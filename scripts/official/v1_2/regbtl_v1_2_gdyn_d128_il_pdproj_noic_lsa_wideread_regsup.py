"""v1.2 register bottleneck noic_lsa d128 wideread + register-grid supervision.

The ``d128_wideread`` run (128-wide storage bottleneck, bottleneck attention at
encoder width -- see ``regbtl_v1_2_gdyn_d128_il_pdproj_noic_lsa_wideread.py``) plus
a low-weight (0.01) supervision head that reads the ENCODER's register grid
...
REGISTER_DIM = 128
MODULE_PATH = (
    "scripts/official/v1_2/regbtl_v1_2_gdyn_d128_il_pdproj_noic_lsa_wideread_regsup.py"
)


def build_model_config(common: CommonComponents) -> LatentMIMConfig:
    """d128 wideread + register-grid supervision of the decode-only modalities."""
