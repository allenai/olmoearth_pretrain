"""d768 teacher + detached pcv student: 50/50 Gram mix + student supervision at 0.01x (ndvi + tanchor) (arm: gramwithin_supstu0p01).
...
ARM = STUDENT_ARMS["gramwithin_supstu0p01"]
MODULE_PATH = (
    "scripts/official/v1_2/"
    "regbtl_v1_2_gdyn_d768_proj128pcv_gramwithin_supstu0p01_ndvi_w1_tanchor_newsampling_psuniform.py"
)
