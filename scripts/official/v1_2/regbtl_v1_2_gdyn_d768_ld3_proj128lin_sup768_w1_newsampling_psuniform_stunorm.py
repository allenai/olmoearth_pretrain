"""stunorm recipe at register_latent_depth=3: block-count ablation, stunorm line.

TWO flags off the RC: ``register_latent_depth = 3`` (the depth contrast -- see the
plain ``ld3`` sibling for the full motivation and MACs arithmetic) and
...
``ld3`` twin isolates depth on the un-normed RC line.
...
MODULE_PATH = "scripts/official/v1_2/regbtl_v1_2_gdyn_d768_ld3_proj128lin_sup768_w1_newsampling_psuniform_stunorm.py"

REGISTER_LATENT_DEPTH = 3


def build_model_config(common: CommonComponents) -> LatentMIMConfig:
    """The stunorm model with a 3-block ([read -> self] x 3) bottleneck."""
