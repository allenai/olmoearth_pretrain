"""d768 teacher + detached perceiver [128, 64] student, sup768 w1 + time-conditioned NDVI supervision.

``regbtl_v1_2_gdyn_d768_proj128pcv_sup768_w1_newsampling_psuniform`` with
the time-conditioned NDVI regsup arm added (MLP on [register_cell ;
phi(day_of_year)] regressing per-cell NDVI at every observed timestep; derived
decode-only modality, excluded from the token budget).
...
MODULE_PATH = "scripts/official/v1_2/regbtl_v1_2_gdyn_d768_proj128pcv_sup768_ndvi_w1_newsampling_psuniform.py"
