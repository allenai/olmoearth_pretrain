"""EARLY READ + SHARED K/V: 6-layer trunk + 25 bottleneck blocks.

``regbtl_v1_2_earlyread_e6_l25_d128_ndvi_tanchor_newsampling_psuniform`` with
...
(l25 vs its partner) is clean. They are NOT directly comparable to the earlier unshared
...
MODULE_PATH = (
    ...
    "regbtl_v1_2_earlyread_e6_l25_d128_ndvi_tanchor_newsampling_psuniform_sharedkv.py"
)


def build_model_config(common: CommonComponents) -> LatentMIMConfig:
    """6-layer trunk + 25 interleaved read/latent blocks over one shared K/V."""
