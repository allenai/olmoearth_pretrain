"""v1.2 register bottleneck noic_lsa with register_dim=512 and all validated speedups.
...
NARROWER register bottleneck (``register_dim=512`` instead of 768), and with the
...
REGISTER_DIM = 512
MODULE_PATH = "scripts/official/v1_2/regbtl_v1_2_gdyn_d512_il_pdproj_noic_lsa_faster.py"


def build_model_config(common: CommonComponents) -> LatentMIMConfig:
    """d512 register bottleneck (latent self-attn ON) with projection-only target."""
