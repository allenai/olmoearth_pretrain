"""d768 teacher + detached pcv student: 50/50 Gram mix + student supervision at 0.01x (ndvi + tanchor) (arm: gramwithin_supstu0p01_flatlr).
...
MODULE_PATH = (
    ...
    "regbtl_v1_2_gdyn_d768_proj128pcv_gramwithin_supstu0p01_flatlr_ndvi_w1_tanchor_newsampling_psuniform.py"
)
