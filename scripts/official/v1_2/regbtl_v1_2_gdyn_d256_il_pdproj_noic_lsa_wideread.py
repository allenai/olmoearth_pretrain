"""v1.2 register bottleneck noic_lsa, register_dim=256, bottleneck attention at ENCODER width.
...
REGISTER_DIM = 256
MODULE_PATH = (
    "scripts/official/v1_2/regbtl_v1_2_gdyn_d256_il_pdproj_noic_lsa_wideread.py"
)


def build_model_config(common: CommonComponents) -> LatentMIMConfig:
    """d256 storage bottleneck with encoder-width (12x64) bottleneck attention."""
