"""d768 teacher + detached perceiver [128, 64] student, sup768 w1 + NDVI supervision + anchored read.

``regbtl_v1_2_gdyn_d768_proj128pcv_sup768_w1_newsampling_psuniform`` with
BOTH the time-conditioned NDVI regsup arm and the anchored register read
(``register_temporal_anchor="year_start"``) added -- the combined temporal arm.
...
MODULE_PATH = "scripts/official/v1_2/regbtl_v1_2_gdyn_d768_proj128pcv_sup768_ndvi_w1_tanchor_newsampling_psuniform.py"
