"""d768 teacher + detached pcv student: 50/50 Gram mix + student supervision at 0.1x (ndvi + tanchor) (arm: gramwithin_supstu0p1_flatlr).
...
though it pays for that stability, peaking 1.3 mIoU BELOW sup768's peak. 0.1x asks
whether a small dose protects without the penalty.
...
ARM = STUDENT_ARMS["gramwithin_supstu0p1_flatlr"]
MODULE_PATH = (
    "scripts/official/v1_2/"
    "regbtl_v1_2_gdyn_d768_proj128pcv_gramwithin_supstu0p1_flatlr_ndvi_w1_tanchor_newsampling_psuniform.py"
)
