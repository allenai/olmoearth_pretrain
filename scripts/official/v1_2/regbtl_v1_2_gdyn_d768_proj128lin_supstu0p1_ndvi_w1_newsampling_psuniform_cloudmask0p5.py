"""d768 teacher + lin supstu0p1 student + NDVI + cloud skip at the 0.5 threshold.
...
MODULE_PATH = (
    ...
    "regbtl_v1_2_gdyn_d768_proj128lin_supstu0p1_ndvi_w1_newsampling_psuniform_cloudmask0p5.py"
)
...
def build_train_module_config(common: CommonComponents) -> LatentMIMTrainModuleConfig:
    """ndvi-aware train module, cloud-skipping."""
    return apply_cloud_skip_threshold(
        apply_microbatch(
