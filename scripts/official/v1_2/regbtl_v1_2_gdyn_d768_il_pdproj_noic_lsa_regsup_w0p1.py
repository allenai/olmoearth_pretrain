"""v1.2 register bottleneck noic_lsa d768 + register-grid supervision at 10x weight.
...
classification/BCE 0.01. Tests whether the low-weight "nudge" was undertuned.
Trains at the base.py default 300 epochs.
...
MODULE_PATH = (
    "scripts/official/v1_2/regbtl_v1_2_gdyn_d768_il_pdproj_noic_lsa_regsup_w0p1.py"
)


def build_model_config(common: CommonComponents) -> LatentMIMConfig:
    """d768 frontier + register-grid supervision at the 10x (0.1) base weight."""
