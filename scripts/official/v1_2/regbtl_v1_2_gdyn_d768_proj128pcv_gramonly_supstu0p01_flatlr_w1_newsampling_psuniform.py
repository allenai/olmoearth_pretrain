"""d768 teacher + detached pcv student: within-scene Gram + student supervision at 0.01x (arm: gramonly_supstu0p01_flatlr).
...
MODULE_PATH = (
    ...
    "regbtl_v1_2_gdyn_d768_proj128pcv_gramonly_supstu0p01_flatlr_w1_newsampling_psuniform.py"
)
