r"""Launch script: osm_sampling + open-set supervised pretraining, d128 latent.

Same as ``open_set_osm_d768.py`` but with a 128-wide spatial latent grid (the
...
Usage (from the repo root)::
    ...
    python scripts/official/v1_2/open_set_osm_d128.py launch open_set_osm_d128 \\
...
MODULE_PATH = "scripts/official/v1_2/open_set_osm_d128.py"
