"""Large model with constant LR for undertraining investigation."""
...
# Toggle this to run with or without maps (OSM)
USE_MAPS = True
...
def build_common_components(
    ...
    if USE_MAPS:
        modalities.append(Modality.OPENSTREETMAP_RASTER.name)

    config.training_modalities = modalities
    return config
...
def build_train_module_config(
    ...
    if USE_MAPS:
        only_decode.append(Modality.OPENSTREETMAP_RASTER.name)
