...
def build_dataset_config(common: CommonComponents) -> HeliosDatasetConfig:
    ...
    return HeliosDatasetConfig(
        h5py_dir="/weka/dfive-default/helios/dataset/presto/h5py_data_w_missing_timesteps_zstd_3/landsat_naip_10_openstreetmap_raster_sentinel1_sentinel2_l2a_srtm_worldcover/117473/",
