...
def build_trainer_config(common: CommonComponents) -> TrainerConfig:
    ...
    WANDB_PROJECT = "2025_08_20_lora_finetune_evals"
    ...
    task_embed_path = "/weka/dfive-default/ryanp/rslearn_projects/one_off_projects/2025_07_joint_finetune/data/task_embeds___Qwen3-Embedding-8B__256d__anchor__instruct.pt"
    factor = 32
    EVAL_TASKS = {
        ...
        "sickle_sentinel1": DownstreamTaskConfig(
            dataset="sickle",
            embedding_batch_size=32 // factor,
            probe_batch_size=16,
            num_workers=2,
            pooling_type=PoolingType.MEAN,
            norm_stats_from_pretrained=True,
