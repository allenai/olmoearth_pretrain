"""Train single band set model on osm_sampling + eurocrops_sampling."""
...
def build_dataset_config(common: CommonComponents) -> OlmoEarthDatasetConfig:
    ...
    return OlmoEarthConcatDatasetConfig(dataset_configs=configs)
...
def build_trainer_config(common: CommonComponents) -> TrainerConfig:
    ...
    WANDB_PROJECT = "2026_02_23_eurocrops_and_single_bandset"
