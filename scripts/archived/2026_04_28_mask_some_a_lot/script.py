"""Launch script for single bandset + random band dropout (no S1) + mostly_encode_mostly_decode masking + masked-negatives loss.
...
- Mostly-encode / mostly-decode masking
...
def _masking_config(
    ...
    return MaskingConfig(
        strategy_config={
            "type": "mostly_encode_mostly_decode",
            "encode_ratio": 0.5,
            "decode_ratio": 0.5,
...
def build_trainer_config(common: CommonComponents) -> TrainerConfig:
    ...
    WANDB_PROJECT = "2026_04_28_mask_some_a_lot"
