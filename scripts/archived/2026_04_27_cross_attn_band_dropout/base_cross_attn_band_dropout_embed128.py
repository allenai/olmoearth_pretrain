"""Cross-attention band dropout (embedding size 128) + single bandset + random time with decode masking + masked-negatives loss.
...
- Cross-attention embedding size: 128
