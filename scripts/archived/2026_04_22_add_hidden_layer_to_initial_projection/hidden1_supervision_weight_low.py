"""hidden1 + supervision with supervision loss weights scaled by 0.1.

Investigates whether tiny supervision is enough to pull the map-modality
probes (pretrain_*_geo_sentinel2_l2a) above the baseline.
"""
