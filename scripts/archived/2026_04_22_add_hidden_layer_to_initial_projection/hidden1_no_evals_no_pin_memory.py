"""Add hidden layer to the initial projection layer — NO EVALS, no pin_memory.

Copy of hidden1_no_evals.py with pin_memory disabled (target_device_type="cpu")
to test whether pin_memory / torch_shm_manager leak causes the memory leak.
"""
