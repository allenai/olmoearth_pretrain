"""Add hidden layer to the initial projection layer — no persistent workers.

Copy of hidden1.py with persistent_workers=False to test whether worker
respawning mitigates the memory leak. Evals are still enabled.
"""
