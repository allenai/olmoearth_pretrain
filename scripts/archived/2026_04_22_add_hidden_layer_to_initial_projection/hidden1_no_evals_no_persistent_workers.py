"""Add hidden layer to the initial projection layer — NO EVALS, no persistent workers.

Copy of hidden1.py with downstream evaluator disabled and persistent_workers=False
to test whether worker respawning mitigates the memory leak.
"""
