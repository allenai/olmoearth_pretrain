"""Add hidden layer to the initial projection layer — reuse_dataloader variant.

Copy of hidden1_no_evals.py with reuse_dataloader=True to prevent
torch_shm_manager process accumulation across epochs.
"""
