"""Add hidden layer to the initial projection layer + gated skip connection from layer 0 to layer 10.

This is adapted from hidden1.py with an additional skip_from_layer=0, skip_to_layer=10
gated residual path in the encoder.
"""
