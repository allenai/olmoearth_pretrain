"""hidden1_supervision with patch-discrimination and InfoNCE weights scaled down by 10x.

Achieves the same supervision:contrastive ratio as
hidden1_supervision_weight_high.py (10x supervision vs default contrastive) but
by lowering the contrastive losses rather than raising the supervision ones,
avoiding the gradient-norm inflation that comes with large supervision weights.
