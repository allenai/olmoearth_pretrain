...
from olmoearth_pretrain.internal.all_evals import (
    PRETRAIN_AUX_EVAL_H5PY_DIR,
    PRETRAIN_SUBSET_H5PY_DIR,
)
...
def build_trainer_config(common: CommonComponents) -> TrainerConfig:
    ...
    EVAL_TASKS = {
        ...
        # ),
        # Map-modality probes for the modalities whose normalization we vary in
        # the fix_srtm_norm / fix_srtm_norm_log_optical experiments. Mirrors the
        # _map_modality_probe configs in olmoearth_pretrain/internal/all_evals.py
        ...
        "pretrain_worldcereal_probe": DownstreamTaskConfig(
            ...
            pretrain_target_modality=Modality.WORLDCEREAL.name,
            pretrain_train_samples=6144,
            pretrain_valid_samples=3072,
            pretrain_test_samples=3072,
            pretrain_split_strategy="random",
