"""Hidden layer patch embed + more data (osm_sampling + eurocrops_sampling + presto).

Based on scripts/archived/2026_04_22_add_hidden_layer_to_initial_projection/hidden1.py
with eurocrops_sampling and presto datasets added via concat dataset config,
and eurocrops enabled as a decode-only modality.
"""
...
def build_dataset_config(common: CommonComponents) -> OlmoEarthConcatDatasetConfig:
    ...
    dataset_configs = [
        ...
        OlmoEarthDatasetConfig(
            h5py_dir="/weka/dfive-default/helios/dataset/presto/h5py_data_w_missing_timesteps_zstd_3_128_x_4/cdl_landsat_openstreetmap_raster_sentinel1_sentinel2_l2a_srtm_worldcereal_worldcover_wri_canopy_height_map/469728",
            training_modalities=common.training_modalities,
        ),
    ]
...
def build_trainer_config(common: CommonComponents) -> TrainerConfig:
    ...
    WANDB_PROJECT = "2026_05_06_moredata"
