"""Single-bandset + hidden-layer builders for candidate ablation experiments.

Adapted from scripts/archived/2026_04_22_add_hidden_layer_to_initial_projection/hidden1.py.
Uses single-bandset tokenization (S2/Landsat), random-time masking with decode,
band dropout (S2 + Landsat only), masked-negatives-vec loss, and a per-pixel
hidden layer (patch_embed_hidden_sizes=[64]) in the encoder stem.
"""
...
from script_config import BASE_H5PY_DIR, CANDIDATE_H5PY_DIR, DEFAULT_PARQUET_PATH
...
# Re-export path constants so the entry script can import them from here.
__all__ = [
    "BASE_H5PY_DIR",
    "CANDIDATE_H5PY_DIR",
...
# ---------------------------------------------------------------------------
# Single-bandset tokenization: all bands in one group per modality
# ---------------------------------------------------------------------------
...
def build_trainer_config(common: CommonComponents) -> TrainerConfig:
    ...
    WANDB_PROJECT = "20260513_candidate_datasets"
