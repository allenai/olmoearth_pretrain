"""Shared builders and constants for candidate ablation experiments.

Mirrors scripts/official/script.py but adds candidate-specific paths.
"""
...
# ---------------------------------------------------------------------------
# Paths -- update these when the on-disk layout changes
# ---------------------------------------------------------------------------
BASE_H5PY_DIR = (
...
# TODO: update with the actual modalities subfolder and sample count once known
CANDIDATE_H5PY_DIR = (
    "/weka/dfive-default/helios/dataset/candidates/"
    "h5py_data_w_missing_timesteps_zstd_3_128_x_1/"
    "cdl_gse_landsat_openstreetmap_raster_sentinel1_sentinel2_l2a_srtm_"
    "worldcereal_worldcover_worldpop_wri_canopy_height_map/<SAMPLE_COUNT>"
)

DEFAULT_PARQUET_PATH = (
    "/weka/dfive-default/helios/dataset/candidates/scored_candidates.parquet"
)
...
def build_trainer_config(common: CommonComponents) -> TrainerConfig:
    ...
    WANDB_PROJECT = "candidate_ablations"
