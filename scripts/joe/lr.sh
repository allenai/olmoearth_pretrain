...
python scripts/joe/latent_mim_large.py launch latent_mim_large.001 ai2/jupiter-cirrascale-2 --launch.priority=urgent --common.launch.num_gpus=8 --train_module.optim_config.lr=0.001
python scripts/joe/latent_mim_large.py launch latent_mim_large.0004 ai2/jupiter-cirrascale-2 --launch.priority=urgent --common.launch.num_gpus=8 --train_module.optim_config.lr=0.0004
