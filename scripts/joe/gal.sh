...
python scripts/joe/galileo.py launch galileo_base_repro_noema_3modalities_fix ai2/jupiter-cirrascale-2 --launch.priority=urgent --common.launch.num_gpus=8 --common.training_modalities=\[sentinel2_l2a,sentinel1,worldcover\]
