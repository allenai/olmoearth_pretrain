""""Supervised extension of pre-training for mid training"""

# Goal is to just directly do supervised training from here
...
def build_train_module_config(
    ...
    scheduler = ConstantWithWarmup(warmup_steps=5000)
...
def build_common_components(
    ...
    config = build_common_components_og(script, cmd, run_name, cluster, overrides)
